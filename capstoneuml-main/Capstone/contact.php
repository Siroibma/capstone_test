...
<html>
   ...
   <div style="position: absolute; background-color: black; height: 500px; width: 384px; top: 140px; left: 400px; opacity: 1;">
    <form id="contact" action="" method="post">
      <div class="form-style-6">
        ...
        <input type="email" name="field5" placeholder="Email Address" />
        
        <textarea name="field6" placeholder="Type your Message"></textarea>
        <input type="submit" value="Send" />
        </form>
        </div>
  </div>
   <div class="tradingview-widget-container" style="position: absolute; left: 1177px;">
