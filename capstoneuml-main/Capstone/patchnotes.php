...
<link href="https://fonts.googleapis.com/css2?family=Varela+Round&display=swap" rel="stylesheet">
   ...
   <div style="position: absolute; background-color: white; height: 30%; width: 20%; top: 25%; left: 30%; opacity: 1;">
    <p style="color: black; text-align: center;">Hello If you would like to keep track of our updates and plans for future updates you can click the link below 
        and it will lead you to a excel sheet that shows our plans for the future and who plans on doing which task. 
        <br>
        <span>Stock Alerts</span>
        <br>
        <a href="https://docs.google.com/spreadsheets/d/1JfsVl5wZVzYN09MQW6Fbhlu5wkPyTez6mLbMSHgfl6A/edit?usp=sharing" style="text-align: center;">Patch Notes</a>
    </p>
  </div>
